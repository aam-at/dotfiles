...
--color=marker:#83a598,spinner:#fabd2f,header:#928374"
        ...
        # set up fzf options
        set -gx FZF_DEFAULT_OPTS (string replace -a "\n" " " -- "
--tmux 100%,50%
--info=inline
--layout reverse
--border top
...
--bind 'btab:up'
--bind 'tab:down'
--bind 'ctrl-h:execute(fish -c __fzf_help)'
")
        set -gx FZF_CTRL_T_OPTS (string replace -a "\n" " " -- "
...
")
        ...
        set -gx FZF_CTRL_R_OPTS (string replace -a "\n" " " -- "
--bind 'ctrl-y:execute-silent(echo -n {2..} | wl-copy)+abort'
--color header:italic
--header 'Press CTRL-Y to copy command into clipboard'
")
        set -gx FZF_ALT_C_OPTS (string replace -a "\n" " " -- "
