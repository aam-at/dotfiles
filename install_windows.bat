choco install ^
7zip adb adobereader ag anki autohotkey calibre clink conemu curl delta dropbox emacs ^
evernote evince far ffmpeg firefox git gnupg google-backup-and-sync googlechrome ^
gpg4win handbrake jre8 latexdraw msys2 notepadplusplus pandoc python ^
