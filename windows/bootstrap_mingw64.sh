...
pacman -Syu \
        ...
        mingw-w64-x86_64-binutils mingw-w64-x86_64-bzip2 mingw-w64-x86_64-cairo \
        mingw-w64-x86_64-crt-git mingw-w64-x86_64-dbus \
        mingw-w64-x86_64-emacs-pdf-tools-server mingw-w64-x86_64-expat \
        ...
        mingw-w64-x86_64-pixman mingw-w64-x86_64-tree-sitter \
        mingw-w64-x86_64-winpthreads mingw-w64-x86_64-wxwidgets3.2-gtk3 \
